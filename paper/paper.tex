...
\(\beta \equiv \mathrm{base}(\bar\zeta_1) = 5/4\) and
...
\(s/\eta > 1\). On the three families the crossover sweeps hold out, it is not; the
fourth, noisy-pure, is the derivation family and is quantified as the control in
Section~\ref{the-law-orders-individual-states}:
...
quantum density matrices}, Phys. Rev. Lett. \textbf{136}, 130602 (2026),
...
families are defined in Section~\ref{what-a-statewise-test-requires}.
