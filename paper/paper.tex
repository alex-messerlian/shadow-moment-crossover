...
range, give clean exponential scalings --- sampled-fit constants, retained
here for the contrast drawn in Section~\ref{sec:zeta-closed-form}, which
quotes \(5.14\) for the same window from the regression on \(M^*(n)\) and
\(5.18\) from the closed forms. Over \(n = 2\) to \(7\),
