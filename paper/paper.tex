...
\textbf{Use of AI tools.} An AI assistant (Anthropic Claude, through the Claude Code
command-line interface, 2026 releases) was used for the derivations of Section~3, the
implementation and its test suite, the simulations and their analysis, the figures, the
literature and bibliography search, the drafting of the text, and adversarial
