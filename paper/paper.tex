...
Section~\ref{where-single-copy-estimation-stops-being-useful} quantifies. A companion study takes
up the real-device case, where neither gate counts nor an idealized primitive are the whole story.
...
magnitude depends on device-specific per-qubit rates and is quantified in a
companion study of the hardware case, but the direction is what matters here, so
