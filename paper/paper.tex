...
the crossover to smaller \(n\) in nine of the ten cells that resolve under
both models and leaves the tenth unchanged. The magnitude of
...
low-rank, and GHZ-noisy) were never used in deriving the law
(Fig.~\ref{fig:ooe}). GHZ
...
of magnitude rather than a breakdown. On the statewise question these four
part differently: the estimand is degenerate on three of them and the fourth,
low-rank, varies too little to resolve an ordering, which is what makes all
four unsuitable for the statewise test of
