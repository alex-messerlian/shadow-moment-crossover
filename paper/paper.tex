...
For \(k \ge 3\) the relevant circuit is instead the ancilla-based Hadamard test, whose transpiled cost against the same map Section~2.3 gives and which is not
comparable. Every \(k \ge 3\) result in this paper is a simulation of an idealized bounded-outcome
...
none of the four families the sweeps use does it
...
result. On the families that the crossover literature, including our own earlier
