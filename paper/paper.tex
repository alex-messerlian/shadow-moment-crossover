...
\textbf{Use of AI tools.} An AI assistant (Anthropic's Claude Opus 5, through the Claude Code
command-line interface, 2026 releases) was used for the initial derivations of Section~3, the
implementation and its test suite, the simulations and their analysis, the figures, the
initial literature and bibliography search, the drafting of the text, and adversarial
attempts to falsify the claims of Section~3. The authors set the research questions, chose
the definitions and the validation design, verified every derivation, and selected what to
report; no result is asserted on the assistant's word.
