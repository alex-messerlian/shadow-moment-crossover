...
in the Methods section: implementing and refactoring the evaluators and estimators, writing
...
design, and are responsible for every claim. No result is asserted on the assistant's word: the Methods section below states how every number
is produced and locked, and the values reported here were regenerated from the committed artifacts
